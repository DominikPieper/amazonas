...
@Component({
  ...
  template: `
    <div
      class="mx-auto flex max-w-screen-sm items-center justify-center space-x-4 py-20 text-sm"
    >
      <p>
        Press
        <code hlmCode>⌘ + K</code>
        ...
        <brn-cmd-list hlm>
          <brn-cmd-group hlm label="Suggestions">
            <button
              brnCmdItem
              value="calendar"
              (selected)="commandSelected('calendar')"
              hlm
            >
              <hlm-icon name="radixCalendar" hlmCmdIcon />
              Calendar
            ...
            <button
              brnCmdItem
              value="emojy"
              (selected)="commandSelected('emojy')"
              hlm
            >
              <hlm-icon name="radixFace" hlmCmdIcon />
              Search Emoji
            ...
            <button
              brnCmdItem
              value="calculator"
              (selected)="commandSelected('calculator')"
              hlm
            >
              <hlm-icon name="radixPlus" hlmCmdIcon />
              Calculator
          ...
          <brn-cmd-group hlm label="Settings">
            <button
              brnCmdItem
              value="profile"
              (selected)="commandSelected('profile')"
              hlm
            >
              <hlm-icon name="radixPerson" hlmCmdIcon />
              Profile
            ...
            <button
              brnCmdItem
              value="billing"
              (selected)="commandSelected('billing')"
              hlm
            >
              <hlm-icon name="radixCardStack" hlmCmdIcon />
              Billing
            ...
            <button
              brnCmdItem
              value="settings"
              (selected)="commandSelected('settings')"
              hlm
            >
              <hlm-icon name="radixGear" hlmCmdIcon />
              Settings
