...
export const LoadingNotStarted: Story = {
  ...
  render: ({ ...args }) => ({
    ...
    <brn-progress class='mt-2 mb-8' aria-labelledby='loading' hlm ${argsToTemplate(
      args,
    )}>
...
export const LoadingStarted: Story = {
  render: ({ ...args }) => ({
    ...
    <brn-progress class='mt-2 mb-8' aria-labelledby='loading started' hlm ${argsToTemplate(
      args,
    )}>
      <brn-progress-indicator hlm/>
    </brn-progress>
...
export const Indeterminate: Story = {
  ...
  render: ({ ...args }) => ({
    ...
    <brn-progress class='mt-2 mb-8' aria-labelledby='indeterminate' hlm ${argsToTemplate(
      args,
    )}>
      <brn-progress-indicator hlm/>
    </brn-progress>
...
export const Complete: Story = {
  ...
  render: ({ ...args }) => ({
    ...
    <brn-progress class='mt-2 mb-8' aria-labelledby='complete' hlm ${argsToTemplate(
      args,
    )}>
      <brn-progress-indicator hlm/>
    </brn-progress>
